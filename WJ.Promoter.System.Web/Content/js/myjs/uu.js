$(function () {
   ...
   '  </div>'
    ...
    function gridList() {
        ...
        $("#gridList").dataGrid({
            url: "/DataCenter/StatisticalData.aspx?method=EachProductUserDistributionDetail&gid=" + gid,
    ...
    function searchHandler() {
        $("#gridList").jqGrid('setGridParam', {
            url: "/DataCenter/StatisticalData.aspx?method=EachProductUserDistributionDetail&gid=" + gid + "&gameuid=" + $('#txt_keyword').val(),
        }).trigger('reloadGrid');
    }
