...
var themes = [["#5b7d8f", "#95AB63", "#BDD684", "#E2F0D6", "#F6FFE0"],
		["#60453f", "#732420", "#BF734C", "#FAD9A0", "#736859"],
		["#314a5d", "#102C2E", "#695F4C", "#EBBC5E", "#FFFBB8"],
		["#5c5e70", "#FFD63E", "#FFB54B", "#E88638", "#8A221C"],
		["#604040", "#E6F2DA", "#C9F24B", "#4D7B85", "#23383D"],
		["#477c80", "#736751", "#F2D7B6", "#BFAC95", "#8C3F3F"],
		["#546d70", "#2D2B2A", "#561812", "#952525", "#FFFFFF"],
		["#a1a3a3", "#B4BD51", "#543B38", "#61594D", "#B8925A"]];
var theme;
...
function init() {
    ...
    document.addEventListener('webkitvisibilitychange', function () {
        if (myinterval) {
            ...
            myinterval = setInterval(loop, 1000 / 40);
    });
    // init box2d
...
function createInstructions() {
    ...
    text.innerHTML = '<span style="color:' + theme[0] + ';font-size:90px;">Hello!</span><br /><br /><span style="font-size:25px;"><strong>欢迎登入推广员后台</strong><br /><br />千智游戏互动<br />&nbsp;深圳&nbsp;维京人&nbsp;&nbsp;<br /> 代理商后台管理<br /><br />感谢!</span>';
    ...
    text.style.left = ((400 - text.clientWidth) / 2) + 'px';
    text.style.top = ((400 - text.clientHeight) / 2) + 'px';
